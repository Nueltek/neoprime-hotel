...
const fallbackOffers = [
  {
    ...
    description: 'Celebrate your love with an unforgettable romantic getaway including champagne and couples spa.',
  ...
  },
  {
    ...
    description: 'Immerse yourself in total relaxation with our comprehensive wellness package.',
  ...
  },
  {
    ...
    description: 'Make the most of your weekend with premium dining, relaxation, and city exploration.',
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {offers.slice(0, 3).map((offer) => (
            <motion.div key={offer._id} variants={fadeUpVariants}>
