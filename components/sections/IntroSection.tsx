  ...
  return (
    <section className="bg-white section-padding">
      ...
      >
        ...
        >
          Welcome to Neoprime Newcastle, where contemporary luxury meets timeless elegance. 
          Experience exceptional dining, sophisticated accommodations, and impeccable service 
