  ...
  return (
    ...
    >
      ...
      <p className="text-center mt-6">
        <a
          href="/"
          className="text-text-muted hover:text-gold transition-colors text-sm font-serif"
        >
          ← Back to website
        </a>
      </p>
...
function LoginFallback() {
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        <div className="w-16 h-16 mx-auto mb-4 bg-white/10 animate-pulse rounded" />
        <div className="h-8 w-32 mx-auto bg-white/10 animate-pulse" />
      </div>
      <div className="bg-luxury-dark border border-white/10 p-8">
        <div className="h-6 w-24 mx-auto bg-white/10 animate-pulse mb-6" />
        <div className="space-y-6">
          <div className="h-12 bg-white/10 animate-pulse" />
          <div className="h-12 bg-white/10 animate-pulse" />
          <div className="h-14 bg-gold/30 animate-pulse" />
        </div>
      </div>
    </div>
  );
