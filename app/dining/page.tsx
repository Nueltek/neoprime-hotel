...
const menuCategories = [
  {
    name: 'Breakfast',
    description: 'Start your day with our carefully crafted breakfast menu, featuring locally sourced ingredients and classic favorites.',
    items: [
  ...
  {
    name: 'Lunch',
    description: 'Light yet satisfying dishes perfect for a midday meal, from fresh salads to gourmet sandwiches.',
    items: [
  ...
  {
    name: 'Dinner',
    description: 'An exquisite evening dining experience featuring prime cuts, fresh seafood, and seasonal specialties.',
    items: [
...
const drinks = [
  {
    category: 'Cocktails',
    items: ['Neoprime Martini', 'Old Fashioned', 'Espresso Martini', 'Champagne Cocktail']
  },
  {
    category: 'Wines',
    items: ['Over 200 labels from renowned vineyards', 'Sommelier recommendations', 'Wine pairing available']
  },
  {
    category: 'Spirits',
    items: ['Premium whisky collection', 'Rare cognacs', 'Artisan gins', 'Craft vodkas']
  }
];
  ...
  return (
    <PublicLayout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpVariants}>
              ...
              <p className="text-text-muted font-serif text-lg leading-relaxed mb-6">
                Step into The Neoprime Grill and discover a world where culinary artistry meets warm hospitality. 
                Our award-winning chefs craft each dish with passion, using only the finest seasonal ingredients 
                sourced from trusted local suppliers.
              </p>
              <p className="text-text-muted font-serif text-lg leading-relaxed mb-8">
                From perfectly aged steaks to fresh seafood, every plate tells a story of quality and dedication. 
                Complement your meal with selections from our extensive wine cellar, curated by our expert sommelier.
              </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3 text-luxury-black">
                  ...
                  <span className="font-serif">Breakfast: 7:00 AM - 10:30 AM</span>
                </div>
                <div className="flex items-center gap-3 text-luxury-black">
                  <Clock size={18} className="text-gold" />
                  <span className="font-serif">Lunch: 12:00 PM - 2:30 PM</span>
                </div>
                <div className="flex items-center gap-3 text-luxury-black">
                  <Clock size={18} className="text-gold" />
                  <span className="font-serif">Dinner: 6:00 PM - 10:00 PM</span>
                </div>
              </div>
              ...
              >
                ...
                <ul className="space-y-3">
                  {category.items.map((item) => (
                    <li key={item} className="text-white font-serif flex items-center gap-2">
      ...
      <section className="section-padding bg-luxury-dark">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpVariants} className="relative aspect-[4/3] overflow-hidden lg:order-2">
              <Image
            ...
            <motion.div variants={fadeUpVariants} className="lg:order-1">
              ...
              <p className="text-text-secondary font-serif text-lg leading-relaxed mb-8">
                Whether you're settling in for pre-dinner drinks or winding down after an eventful day, 
                The Bar offers the perfect setting. Our skilled mixologists craft innovative cocktails 
                alongside timeless classics, while our carefully curated selection of wines and spirits 
              ...
              <div className="space-y-6 mb-8">
                {drinks.map((drink) => (
                  <div key={drink.category}>
                    <h4 className="text-gold font-sans uppercase tracking-wide mb-2">{drink.category}</h4>
            ...
            <div className="absolute inset-0 flex items-center justify-center text-center">
              <div>
                ...
                <p className="text-white/80 font-serif max-w-2xl mx-auto mb-8 px-6">
                  ...
                  From intimate gatherings to corporate events, we create bespoke experiences.
                </p>
      ...
      <section className="section-padding bg-white">
        ...
        >
          ...
          <p className="text-text-muted font-serif text-lg max-w-2xl mx-auto mb-8">
            Whether you're celebrating a special occasion or simply enjoying an evening out, 
